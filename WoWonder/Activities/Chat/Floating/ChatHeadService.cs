        ...
        public override StartCommandResult OnStartCommand(Intent intent, StartCommandFlags flags, int startId)
        {
            try
            {
                if (MFloatingViewManager == null)
                {
                    ...
                    var iconView = Inflater?.Inflate(_Microsoft.Android.Resource.Designer.ResourceConstant.Layout.WidgetChatHeadLayout, null, false);

                    Image = iconView?.FindViewById<ImageView>(_Microsoft.Android.Resource.Designer.ResourceConstant.Id.imageFloating);
                    ...
                    try
                    {
                        ...
                        if (DataUser != null)
                        {
                            Glide.With(Application.Context).Load(DataUser.Avatar).Apply(new RequestOptions().CircleCrop().Placeholder(_Microsoft.Android.Resource.Designer.ResourceConstant.Drawable.no_profile_image_circle)).Into(Image);
                    ...
                    MFloatingViewManager.SetFixedTrashIconImage(Application.Context.GetDrawable(_Microsoft.Android.Resource.Designer.ResourceConstant.Drawable.ic_trash_fixed));
                    MFloatingViewManager.SetActionTrashIconImage(Application.Context.GetDrawable(_Microsoft.Android.Resource.Designer.ResourceConstant.Drawable.ic_trash_action));
...
#pragma warning restore CS0618
        ...
        private void CreateNotification(Context context)
        {
            try
            {
                ...
                .SetSmallIcon(_Microsoft.Android.Resource.Designer.ResourceConstant.Mipmap.icon)
                .SetColor(ContextCompat.GetColor(this, _Microsoft.Android.Resource.Designer.ResourceConstant.Color.accent))
                .SetContentTitle(context.GetString(_Microsoft.Android.Resource.Designer.ResourceConstant.String.Lbl_ChatHead_Title))
                .SetContentText(context.GetString(_Microsoft.Android.Resource.Designer.ResourceConstant.String.Lbl_ChatHead_Text))
