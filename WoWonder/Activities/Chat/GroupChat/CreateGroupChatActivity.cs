...
namespace WoWonder.Activities.Chat.GroupChat
{
    ...
    public class CreateGroupChatActivity : BaseActivity
    {
                    ...
                    else
                    {
                        ...
                        if (apiStatus == 200)
                        {
                            if (respond is CreateGroupChatObject result)
                            {
                                ...
                                {
                                    var itemChatObject = result.Data.FirstOrDefault();
                                    if (itemChatObject != null)
                                    {
                                        ...
                                        var intent = new Intent(this, typeof(GroupChatWindowActivity));
