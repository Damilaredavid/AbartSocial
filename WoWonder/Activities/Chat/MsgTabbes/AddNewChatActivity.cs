    ...
    public class AddNewChatActivity : BaseActivity, TextView.IOnEditorActionListener
    {
        ...
        private void SetRecyclerViewAdapters()
        {
            try
            {
                ...
                if (AppSettings.EnableBroadcast)
                {
                    MAdapter.UserList.Add(new Classes.AddNewChatObject()
                    {
                        Id = "003",
                        Text = GetText(Resource.String.Lbl_CreateNewBroadcast),
                        Type = Classes.ItemType.AddBroadcast,
                    });
                }
            }
            catch (Exception e)
        ...
        private void MAdapterOnItemClick(object sender, Holders.GlobalClickEventArgs e)
        {
            try
            {
