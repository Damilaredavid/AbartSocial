...
{
    [Service(Exported = true, ForegroundServiceType = ForegroundService.TypeConnectedDevice, Permission = "android.permission.BIND_JOB_SERVICE")]
    public class AppApiService : JobService
    {
        ...
        private void CreateNotificationChannel()
        {
            try
            {
                ...
                {
                    StartForeground(NotificationId, Notification?.Build(), ForegroundService.TypeConnectedDevice);
                }
                else
                {
